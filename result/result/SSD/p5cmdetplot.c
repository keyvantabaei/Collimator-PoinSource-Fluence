...
TString detector="APH5cm";
  ...
  TFile* r1 = new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/SSD/100/result.root");
  TFile* r2 = new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/SSD/80/result.root");             
  TFile* r3 = new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/SSD/70/result.root");       
  TFile* r4 = new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/SSD/60/result.root");        
TFile* r1234= new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/SSD/50/result.root");        
...
TH1D* hist1234= (TH1D*)r1234->Get(detector);
 ...
 detector="SPH5cm";
  ...
  TFile* r6 = new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/SSD/80/result.root");             
  TFile* r7 = new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/SSD/70/result.root");
  TFile* r8 = new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/SSD/60/result.root");       
TFile* r5678= new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/SSD/50/result.root"); 
...
detector="E5cm";
  ...
  TFile* r9  = new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/SSD/100/result.root");
  TFile* r10 = new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/SSD/80/result.root");      
  TFile* r11 = new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/SSD/70/result.root");    
  TFile* r12 = new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/SSD/60/result.root");       
  TFile* r912= new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/SSD/50/result.root");
  ...
  TH1D* hist912 = (TH1D*)r912->Get(detector);
   ...
   hist12->SetTitle("Electron Energy Spectrom Per 50; Energy (keV) ; Electron");
