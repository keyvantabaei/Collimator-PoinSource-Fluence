...
TString detector="E15cm";
  ...
  TH1D* hist4 = (TH1D*)r4->Get(detector);
   ...
   hist4->SetTitle("Electrons Energy Spectrom Per 50 keV 5x5 cm ; Energy (keV) ; Electron");
  ...
  TH1D* hist8 = (TH1D*)r8->Get(detector);
   ...
   hist8->SetTitle("Electrons Energy Spectrom Per 50 keV 7x7 cm; Energy (keV) ; Electron");
  ...
  TH1D* hist12 = (TH1D*)r12->Get(detector);
   ...
   hist12->SetTitle("Electrons Energy Spectrom Per 50 keV 10x10 cm; Energy (keV) ; Electron");
  ...
  TH1D* hist16 = (TH1D*)r16->Get(detector);
   ...
   hist16->SetTitle("Electrons Energy Spectrom Per 50 keV 15x15 cm; Energy (keV) ; Electron");
  ...
  TH1D* hist20 = (TH1D*)r20->Get(detector);
   ...
   hist20->SetTitle("Electrons Energy Spectrom Per 50 keV 20x20 cm; Energy (keV) ; Electron");
