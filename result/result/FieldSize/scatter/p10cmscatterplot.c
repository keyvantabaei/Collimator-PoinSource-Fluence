...
TString detector="SPH10cm";
  ...
  TFile* r2 = new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/Energy 500keV/r2/result.root");             
  TFile* r3 = new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/Energy 500keV/r3/result.root");       
  TFile* r4 = new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/Energy 500keV/r4/result.root");        
TFile* r1234= new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/Energy 500keV/r5/result.root");        
...
TH1D* hist1234= (TH1D*)r1234->Get(detector);
   ...
   hist1->SetTitle("Scattered Photon Energy Spectrom Per 50 keV, 500keV ; Energy (keV) ; Photons");
  ...
  TFile* r5 = new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/Energy co60/r1/result.root");
  TFile* r6 = new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/Energy co60/r2/result.root");             
  TFile* r7 = new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/Energy co60/r3/result.root");       
  TFile* r8 = new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/Energy co60/r4/result.root");        
TFile* r5678= new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/Energy co60/r5/result.root");  
  ...
  TH1D* hist5678 = (TH1D*)r5678->Get(detector);
   ...
   hist5->SetTitle("Scattered Photon Energy Spectrom Per 50 keV Co60; Energy (keV) ; Photons");
  ...
  TFile* r9  = new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/Energy 2MeV/r1/result.root");
  TFile* r10 = new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/Energy 2MeV/r2/result.root");             
  TFile* r11 = new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/Energy 2MeV/r3/result.root");       
  TFile* r12 = new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/Energy 2MeV/r4/result.root");        
  TFile* r912= new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/Energy 2MeV/r5/result.root");  
  ...
  TH1D* hist912 = (TH1D*)r912->Get(detector);
   ...
   hist912->SetTitle("Scattered Photon Energy Spectrom Per 50 keV 2 MeV; Energy (keV) ; Photons");
  ...
  TFile* r17 = new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/Energy 4MeV/r1/result.root");
  TFile* r18 = new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/Energy 4MeV/r2/result.root");             
  TFile* r19 = new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/Energy 4MeV/r3/result.root");       
  TFile* r20 = new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/Energy 4MeV/r4/result.root");        
 TFile* r1720= new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/Energy 4MeV/r5/result.root"); 
  ...
  TH1D* hist1720 = (TH1D*)r1720->Get(detector);
   ...
   hist1720->SetTitle("Scattered Photon Energy Spectrom Per 50 keV 4 MeV; Energy (keV) ; Photons");
