...
TH1D* hist1234= (TH1D*)r1234->Get(detector);
   ...
   hist1->SetTitle("ALL Photon Energy Spectrom Per 50 keV, 500keV ; Energy (keV) ; Photons");
...
TFile* r5678= new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/Energy co60/r5/result.root");  
  ...
  TH1D* hist5678 = (TH1D*)r5678->Get(detector);
   ...
   hist5->SetTitle("ALL Photon Energy Spectrom Per 50 keV Co60; Energy (keV) ; Photons");
  ...
  TH1D* hist912 = (TH1D*)r912->Get(detector);
   ...
   hist12->SetTitle("ALL Photon Energy Spectrom Per 50 keV 2 MeV; Energy (keV) ; Photons");
 ...
 TFile* r1720= new TFile("/home/k1/k1-Files/Programing/Geant4-workshop/reports/2/result/Energy 4MeV/r5/result.root"); 
  ...
  TH1D* hist1720 = (TH1D*)r1720->Get(detector);
   ...
   hist20->SetTitle("ALL Photon Energy Spectrom Per 50 keV 4 MeV; Energy (keV) ; Photons");
