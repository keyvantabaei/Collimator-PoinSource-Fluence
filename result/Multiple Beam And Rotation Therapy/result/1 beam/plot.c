...
h2_pddxz->SetBinContent(i,j,(h2zx->GetBinContent(i,j)/max_depth_dose)*100);
   ...
   h2_pddxy->GetXaxis()->SetLabelOffset(999);
   h2_pddxy->GetXaxis()->SetLabelSize(0);
   h2_pddxy->GetYaxis()->SetLabelOffset(999);
   h2_pddxy->GetYaxis()->SetLabelSize(0);
   
   h2_pddxy->SetTitle("Isodose 10 MeV 1 Plan Source; Y (mm) ; X (mm)");
   h2_pddxy->Smooth();
   ...
   h2_pddxz->GetXaxis()->SetLabelOffset(999);
   h2_pddxz->GetXaxis()->SetLabelSize(0);
   h2_pddxz->GetYaxis()->SetLabelOffset(999);
   h2_pddxz->GetYaxis()->SetLabelSize(0);

   h2_pddxz->SetTitle("Isodose 10 MeV 1 Plan Source; X (mm) ; Z (mm)");
   h2_pddxz->Smooth();
